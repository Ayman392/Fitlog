...
export default function PlanList() {
  ...
  return (
    <div className="mx-auto max-w-7xl py-8">
      {/* Page title */}
      <h1 className={`${oswald.className} text-3xl font-bold text-white uppercase`}>
        My Plan
      </h1>
      ...
      <div className="stats stats-vertical my-6 w-full border border-[#24272e] bg-[#13161c] shadow-none sm:stats-horizontal">
        <div className="stat">
          <div className="stat-title text-xs text-gray-400">
            Exercises
          </div>
    ...
    {displayedWorkouts.map((workout) => (
      ...
      >
        ...
        <div className="flex-1">
          <h3 className={`${oswald.className} font-bold text-white uppercase`}>
            {workout.name}
          </h3>
